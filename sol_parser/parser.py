...
When the parser is called it accepts a single positional argument: reference to a csv file
...
class ScoutsCollection():
    ...
    Attributes:
        __migration_date__ (datetime): Migration date used to calculate which scouts should transfer to the next group when the season ends (at the migration date)
    ...
    def group(self, filter_list, key):
        ...
        Args:
            ...
            key (string) : key name of the member attributes to match the values defined in filter list
        """
        ret = dict()
